...
> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install court-listener`
...
```ts
import CourtListener from 'npm:court-listener';
