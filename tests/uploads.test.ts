import fs from 'fs';
import type { ResponseLike } from 'court-listener/internal/to-file';
import { toFile } from 'court-listener/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('court-listener/core/uploads');
    await expect(
